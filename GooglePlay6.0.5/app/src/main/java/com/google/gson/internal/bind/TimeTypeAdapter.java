  ...
  extends TypeAdapter<Time>
{
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory()
  {
    ...
    {
      if (paramAnonymousTypeToken.rawType == Time.class) {
  ...
  /* Error */
  private Time read(com.google.gson.stream.JsonReader paramJsonReader)
    throws IOException
  {
    // Byte code:
    //   0: aload_0
    ...
    //   40: invokespecial 70	java/sql/Time:<init>	(J)V
    //   43: astore_3
    //   44: goto -26 -> 18
    //   47: astore 4
  ...
  private void write(JsonWriter paramJsonWriter, Time paramTime)
    throws IOException
  {
    if (paramTime == null) {}
    String str;
