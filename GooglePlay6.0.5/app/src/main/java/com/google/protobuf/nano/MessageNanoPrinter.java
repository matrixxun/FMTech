...
public final class MessageNanoPrinter
{
    ...
    throws IllegalAccessException, InvocationTargetException
  {
          ...
          if ((localClass2.isArray()) && (localClass2.getComponentType() != Byte.TYPE))
          {
            ...
            for (int i2 = 0;; i2 = Array.getLength(localObject)) {
              for (int i3 = 0; i3 < i2; i3++) {
                print(str6, Array.get(localObject, i3), paramStringBuffer1, paramStringBuffer2);
              }
            }
          }
          print(str6, localObject, paramStringBuffer1, paramStringBuffer2);
        }
      }
      ...
      while (n < m)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            print(str5, localMethod2.invoke(paramObject, new Object[0]), paramStringBuffer1, paramStringBuffer2);
            n++;
          }
    ...
    return;
    label410:
    str1 = deCamelCaseify(paramString);
