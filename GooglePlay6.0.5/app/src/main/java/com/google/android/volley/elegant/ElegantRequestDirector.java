...
public final class ElegantRequestDirector
  extends DefaultRequestDirector
{
  ...
  protected final void establishRoute(HttpRoute paramHttpRoute, HttpContext paramHttpContext)
    throws HttpException, IOException
  {
    this.managedConn.setSocketTimeout(HttpConnectionParams.getSoTimeout(this.params));
    super.establishRoute(paramHttpRoute, paramHttpContext);
  }
}


/* Location:           F:\apktool\apktool\Google_Play_Store6.0.5\classes-dex2jar.jar
 * Qualified Name:     com.google.android.volley.elegant.ElegantRequestDirector
