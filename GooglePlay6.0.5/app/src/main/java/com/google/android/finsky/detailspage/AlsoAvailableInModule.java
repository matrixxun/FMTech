...
public class AlsoAvailableInModule
  ...
  implements Libraries.Listener
{
  ...
  public final void bindView(View paramView)
  {
    ...
    if ((!localBundleCardClusterModuleLayout.mIsBound) || (this.mNeedsRefresh))
    {
      ...
      localBundleCardClusterModuleLayout.bind(((SimpleDfeListModule.Data)this.mModuleData).dfeList, this.mBitmapLoader, this.mNavigationManager, this.mParentNode, 18);
    }
  }
  
  protected final SimpleDfeListModule.Data createModuleDataWithListUrl(Document paramDocument)
  {
    if ((paramDocument.mDocument.docType != 6) || (TextUtils.isEmpty(paramDocument.getVideoAlsoAvailableInListUrl()))) {
      return null;
    }
    SimpleDfeListModule.Data localData = new SimpleDfeListModule.Data();
    localData.listUrl = paramDocument.getVideoAlsoAvailableInListUrl();
    return localData;
  }
 ...
 * Qualified Name:     com.google.android.finsky.detailspage.AlsoAvailableInModule
