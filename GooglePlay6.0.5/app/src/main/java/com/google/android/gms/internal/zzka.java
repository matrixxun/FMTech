...
public abstract interface zzka
  extends IInterface
{
  public abstract IBinder zzr(zzd paramzzd)
  ...
  public static abstract class zza
    ...
    implements zzka
  {
    public static zzka zzal(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzka))) {
        return (zzka)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      IBinder localIBinder = zzr(zzd.zza.zzdb(paramParcel1.readStrongBinder()));
      ...
      implements zzka
    {
      ...
      /* Error */
      public final IBinder zzr(zzd paramzzd)
        throws RemoteException
      {
        // Byte code:
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/internal/zzka$zza$zza:zzop	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
