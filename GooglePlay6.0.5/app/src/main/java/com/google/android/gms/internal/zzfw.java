...
public abstract interface zzfw
  extends IInterface
{
  public abstract IBinder zzi(zzd paramzzd)
  ...
  public static abstract class zza
    ...
    implements zzfw
  {
    public static zzfw zzQ(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      IBinder localIBinder = zzi(zzd.zza.zzdb(paramParcel1.readStrongBinder()));
      ...
      implements zzfw
    {
      ...
      /* Error */
      public final IBinder zzi(zzd paramzzd)
        throws RemoteException
      {
        // Byte code:
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/internal/zzfw$zza$zza:zzop	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
