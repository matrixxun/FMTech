  ...
  implements WithForegroundLayer
{
  ...
  public final void setForegroundPadding(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.mForegroundPaddingLeft = paramInt1;
    this.mForegroundPaddingTop = paramInt2;
    this.mForegroundPaddingRight = paramInt3;
    this.mForegroundPaddingBottom = paramInt4;
    requestLayout();
    invalidate();
  }
 ...
 * Qualified Name:     com.google.android.play.layout.ForegroundRelativeLayout
