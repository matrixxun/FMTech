...
public final class PlayCardClusterWithNoticeRepository
{
  ...
  private static final PlayCardClusterMetadata sOneMiniCardCluster;
  ...
  static
  {
    ...
    PlayCardClusterMetadata localPlayCardClusterMetadata2 = localPlayCardClusterMetadata1.addTile(PlayCardClusterMetadata.CARD_MINI, 4, 0);
    localPlayCardClusterMetadata2.mAlignToParentEndIfNecessary = true;
    sOneMiniCardCluster = localPlayCardClusterMetadata2;
    ...
    localPlayCardClusterMetadata3.mLeadingGap = 0;
    PlayCardClusterMetadata localPlayCardClusterMetadata4 = localPlayCardClusterMetadata3.addTile(PlayCardClusterMetadata.CARD_MINI, 2, 0).addTile(PlayCardClusterMetadata.CARD_MINI, 4, 0).addTile(PlayCardClusterMetadata.CARD_MINI, 6, 0);
    ...
    localSparseArray1.append(0, localPlayCardClusterMetadata4);
    ...
    PlayCardClusterMetadata localPlayCardClusterMetadata6 = localPlayCardClusterMetadata5.addTile(PlayCardClusterMetadata.CARD_MINI, 4, 0).addTile(PlayCardClusterMetadata.CARD_MINI, 6, 0);
    ...
    localSparseArray2.append(1, localPlayCardClusterMetadata6);
    SparseArray localSparseArray3 = sClusters1x1;
    PlayCardClusterMetadata localPlayCardClusterMetadata7 = new PlayCardClusterMetadata(6, 3);
    localPlayCardClusterMetadata7.mLeadingGap = 0;
    PlayCardClusterMetadata localPlayCardClusterMetadata8 = localPlayCardClusterMetadata7.addTile(PlayCardClusterMetadata.CARD_SMALL, 2, 0).addTile(PlayCardClusterMetadata.CARD_SMALL, 4, 0).addTile(PlayCardClusterMetadata.CARD_SMALL, 6, 0);
    ...
    localSparseArray3.append(2, localPlayCardClusterMetadata8);
    ...
    localSparseArray4.append(3, localPlayCardClusterMetadata10);
    SparseArray localSparseArray5 = sClusters1x1;
    PlayCardClusterMetadata localPlayCardClusterMetadata11 = new PlayCardClusterMetadata(8, 3);
    localPlayCardClusterMetadata11.mLeadingGap = 4;
    PlayCardClusterMetadata localPlayCardClusterMetadata12 = localPlayCardClusterMetadata11.addTile(PlayCardClusterMetadata.CARD_SMALL, 4, 0).addTile(PlayCardClusterMetadata.CARD_SMALL, 6, 0);
    ...
    localSparseArray5.append(4, localPlayCardClusterMetadata12);
    SparseArray localSparseArray6 = sClusters1x1;
    PlayCardClusterMetadata localPlayCardClusterMetadata13 = new PlayCardClusterMetadata(10, 3);
    localPlayCardClusterMetadata13.mLeadingGap = 4;
    PlayCardClusterMetadata localPlayCardClusterMetadata14 = localPlayCardClusterMetadata13.addTile(PlayCardClusterMetadata.CARD_SMALL, 4, 0).addTile(PlayCardClusterMetadata.CARD_SMALL, 6, 0).addTile(PlayCardClusterMetadata.CARD_SMALL, 8, 0);
    ...
    localSparseArray6.append(5, localPlayCardClusterMetadata14);
    SparseArray localSparseArray7 = sClusters16x9;
    PlayCardClusterMetadata localPlayCardClusterMetadata15 = new PlayCardClusterMetadata(6, 4);
    localPlayCardClusterMetadata15.mLeadingGap = 0;
    PlayCardClusterMetadata localPlayCardClusterMetadata16 = localPlayCardClusterMetadata15.addTile(PlayCardClusterMetadata.CARD_MINI, 2, 0).addTile(PlayCardClusterMetadata.CARD_MINI, 4, 0).addTile(PlayCardClusterMetadata.CARD_MINI_16x9, 6, 0);
    ...
    localSparseArray7.append(0, localPlayCardClusterMetadata16);
    SparseArray localSparseArray8 = sClusters16x9;
    PlayCardClusterMetadata localPlayCardClusterMetadata17 = new PlayCardClusterMetadata(8, 4);
    localPlayCardClusterMetadata17.mLeadingGap = 4;
    PlayCardClusterMetadata localPlayCardClusterMetadata18 = localPlayCardClusterMetadata17.addTile(PlayCardClusterMetadata.CARD_MINI_16x9, 4, 0).addTile(PlayCardClusterMetadata.CARD_MINI_16x9, 6, 0);
    ...
    localSparseArray8.append(1, localPlayCardClusterMetadata18);
    SparseArray localSparseArray9 = sClusters16x9;
    PlayCardClusterMetadata localPlayCardClusterMetadata19 = new PlayCardClusterMetadata(6, 4);
    localPlayCardClusterMetadata19.mLeadingGap = 2;
    PlayCardClusterMetadata localPlayCardClusterMetadata20 = localPlayCardClusterMetadata19.addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 2, 0).addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 4, 0);
    ...
    localSparseArray9.append(2, localPlayCardClusterMetadata20);
    ...
    localSparseArray10.append(3, localPlayCardClusterMetadata22);
    SparseArray localSparseArray11 = sClusters16x9;
    PlayCardClusterMetadata localPlayCardClusterMetadata23 = new PlayCardClusterMetadata(8, 4);
    localPlayCardClusterMetadata23.mLeadingGap = 4;
    PlayCardClusterMetadata localPlayCardClusterMetadata24 = localPlayCardClusterMetadata23.addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 4, 0).addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 6, 0);
    ...
    localSparseArray11.append(4, localPlayCardClusterMetadata24);
    SparseArray localSparseArray12 = sClusters16x9;
    PlayCardClusterMetadata localPlayCardClusterMetadata25 = new PlayCardClusterMetadata(10, 4);
    localPlayCardClusterMetadata25.mLeadingGap = 4;
    PlayCardClusterMetadata localPlayCardClusterMetadata26 = localPlayCardClusterMetadata25.addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 4, 0).addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 6, 0).addTile(PlayCardClusterMetadata.CARD_SMALL_16x9, 8, 0);
    ...
    localPlayCardClusterMetadata26.mAlignToParentEndIfNecessary = true;
    localSparseArray12.append(5, localPlayCardClusterMetadata26);
  }
  
  public static PlayCardClusterMetadata getMetadata(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    if ((paramInt2 == 2) && (paramInt3 < 3)) {
      return sOneMiniCardCluster;
    }
    int i;
 ...
 * Qualified Name:     com.google.android.finsky.layout.play.PlayCardClusterWithNoticeRepository
