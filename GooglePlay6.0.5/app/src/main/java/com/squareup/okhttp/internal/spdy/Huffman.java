...
final class Huffman
{
  ...
  private void buildTree()
  {
    ...
    {
      int j = CODES[i];
      int k = CODE_LENGTHS[i];
      Node localNode1 = new Node(i, k);
      Node localNode2 = this.root;
      int i4;
      for (int m = k; m > 8; m = i4)
      {
        i4 = (byte)(m - 8);
        int i5 = 0xFF & j >>> i4;
        ...
        if (localNode2.children[i5] == null) {
          localNode2.children[i5] = new Node();
        }
        localNode2 = localNode2.children[i5];
      }
      int n = 8 - m;
      int i1 = 0xFF & j << n;
      int i2 = 1 << n;
      for (int i3 = i1; i3 < i1 + i2; i3++) {
        localNode2.children[i3] = localNode1;
      }
    }
  }
