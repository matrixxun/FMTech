  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes$1a6c1917(paramContext, paramAttributeSet, R.styleable.LinearLayoutCompat, paramInt);
    ...
    int k = R.styleable.LinearLayoutCompat_android_weightSum;
    this.mWeightSum = localTintTypedArray.mWrapped.getFloat(k, -1.0F);
  ...
  void measureHorizontal(int paramInt1, int paramInt2)
  {
    ...
    if (localView5.getVisibility() != 8)
    {
      ...
      i35 = i34 + localView5.getMeasuredHeight();
      int i36 = ViewCompat.getMeasuredState(localView5);
      j = ViewUtils.combineMeasuredStates(j, i36);
      if (bool1)
      {
        int i37 = localView5.getBaseline();
        if (i37 != -1)
        {
    ...
    for (;;)
    {
      ...
      if (f1 == 0.0F)
      {
        ...
        measureChildBeforeLayout(localView5, i8, paramInt1, i30, paramInt2, 0);
        if (i29 != -2147483648) {
          localLayoutParams3.width = i29;
        }
        i31 = localView5.getMeasuredWidth();
        if (i6 == 0) {
          break label717;
        }
      }
      label717:
      int i32;
      for (this.mTotalLength += i31 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView5);; this.mTotalLength = Math.max(i32, i32 + i31 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView5)))
      {
        if (!bool2) {
          break label757;
        }
      ...
      break label326;
      label759:
      i38 = localLayoutParams3.gravity;
      break label429;
      label769:
      n = 0;
      break label500;
    ...
    if ((bool2) && ((i2 == -2147483648) || (i2 == 0)))
    {
      ...
      if (i27 < i1)
      {
        View localView4 = getVirtualChildAt(i27);
        if (localView4 == null) {
        ...
        for (;;)
        {
          ...
          {
            i27 += getChildrenSkipCount(localView4, i27);
          }
          else
          {
            ...
            else
            {
              ...
              this.mTotalLength = Math.max(i28, i28 + i7 + localLayoutParams2.leftMargin + localLayoutParams2.rightMargin + getNextLocationOffset(localView4));
            }
          }
        }
      }
      ...
      if (this.mWeightSum > 0.0F)
      {
        ...
        if ((localView1 != null) && (localView1.getVisibility() != 8))
        {
          ...
          if (f3 > 0.0F)
          {
            ...
            f2 -= f3;
            i11 -= i22;
            int i23 = getChildMeasureSpec(paramInt2, getPaddingTop() + getPaddingBottom() + localLayoutParams1.topMargin + localLayoutParams1.bottomMargin, localLayoutParams1.height);
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    while (i8 < i1)
    {
      View localView5 = getVirtualChildAt(i8);
      if (localView5 == null)
      {
        this.mTotalLength += measureNullChild(i8);
        i8++;
      ...
      else
      {
        ...
        if (localView5.getVisibility() != 8)
        {
          ...
          if ((i3 == 1073741824) && (localLayoutParams3.height == 0) && (localLayoutParams3.weight > 0.0F))
          {
            ...
            this.mTotalLength = Math.max(i32, i32 + localLayoutParams3.topMargin + localLayoutParams3.bottomMargin);
            i5 = 1;
            if ((i6 >= 0) && (i6 == i8 + 1)) {
          ...
          else
          {
            ...
            if (f1 == 0.0F) {}
            for (int i24 = this.mTotalLength;; i24 = 0)
            {
              measureChildBeforeLayout(localView5, i8, paramInt1, 0, paramInt2, i24);
              if (i23 != -2147483648) {
                localLayoutParams3.height = i23;
              }
              int i25 = localView5.getMeasuredHeight();
              int i26 = this.mTotalLength;
              this.mTotalLength = Math.max(i26, i26 + i25 + localLayoutParams3.topMargin + localLayoutParams3.bottomMargin + getNextLocationOffset(localView5));
              if (!bool) {
                break;
              }
              i7 = Math.max(i25, i7);
          ...
          if (i2 != 1073741824)
          {
            int i31 = localLayoutParams3.width;
            i27 = 0;
            if (i31 == -1)
            {
              i4 = 1;
          ...
          i28 = localLayoutParams3.leftMargin + localLayoutParams3.rightMargin;
          i29 = i28 + localView5.getMeasuredWidth();
          i = Math.max(i, i29);
          int i30 = ViewCompat.getMeasuredState(localView5);
          j = ViewUtils.combineMeasuredStates(j, i30);
    ...
    if ((bool) && ((i3 == -2147483648) || (i3 == 0)))
    {
      ...
      if (i21 < i1)
      {
        View localView4 = getVirtualChildAt(i21);
        if (localView4 == null) {
        ...
        for (;;)
        {
          ...
          if (localView4.getVisibility() == 8)
          {
            i21 += getChildrenSkipCount(localView4, i21);
          }
          else
          {
            LayoutParams localLayoutParams2 = (LayoutParams)localView4.getLayoutParams();
            int i22 = this.mTotalLength;
            this.mTotalLength = Math.max(i22, i22 + i7 + localLayoutParams2.topMargin + localLayoutParams2.bottomMargin + getNextLocationOffset(localView4));
          }
        }
      }
    }
      ...
      if (this.mWeightSum > 0.0F)
      {
        ...
        if (localView1.getVisibility() != 8)
        {
          ...
          if (f3 > 0.0F)
          {
            ...
            f2 -= f3;
            i10 -= i16;
            int i17 = getChildMeasureSpec(paramInt1, getPaddingLeft() + getPaddingRight() + localLayoutParams1.leftMargin + localLayoutParams1.rightMargin, localLayoutParams1.width);
            ...
            int i19 = 0xFFFFFF00 & ViewCompat.getMeasuredState(localView1);
            j = ViewUtils.combineMeasuredStates(j, i19);
          }
