  ...
  implements CollapsibleActionView
{
  ...
  private Runnable mShowImeRunnable = new Runnable()
  {
    public final void run()
    {
      ...
      if (localInputMethodManager != null)
      {
        ...
        if (localAutoCompleteTextViewReflector.showSoftInputUnchecked == null) {}
      }
      else
      {
        try
        {
          Method localMethod = localAutoCompleteTextViewReflector.showSoftInputUnchecked;
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes$1a6c1917(paramContext, paramAttributeSet, R.styleable.SearchView, paramInt);
  ...
  private void forceSuggestionQuery()
  {
    ...
    SearchAutoComplete localSearchAutoComplete1 = this.mSearchSrcTextView;
    if (localAutoCompleteTextViewReflector1.doBeforeTextChanged != null) {}
    try
    {
      localAutoCompleteTextViewReflector1.doBeforeTextChanged.invoke(localSearchAutoComplete1, new Object[0]);
      label29:
      AutoCompleteTextViewReflector localAutoCompleteTextViewReflector2 = HIDDEN_METHOD_INVOKER;
      SearchAutoComplete localSearchAutoComplete2 = this.mSearchSrcTextView;
      if (localAutoCompleteTextViewReflector2.doAfterTextChanged != null) {}
      try
      {
        localAutoCompleteTextViewReflector2.doAfterTextChanged.invoke(localSearchAutoComplete2, new Object[0]);
        return;
      }
  ...
  {
    Cursor localCursor = this.mSuggestionsAdapter.mCursor;
  ...
  private boolean onItemClicked(int paramInt1, int paramInt2, String paramString)
  {
    ...
    {
      boolean bool2 = this.mOnSuggestionListener.onSuggestionClick$134632();
      bool1 = false;
      if (bool2) {}
    }
    else
  ...
  {
    if ((this.mOnSuggestionListener == null) || (!this.mOnSuggestionListener.onSuggestionSelect$134632()))
    {
  ...
  private void onSubmitQuery()
  {
    ...
    if ((localEditable != null) && (TextUtils.getTrimmedLength(localEditable) > 0)) {
      if (this.mOnQueryChangeListener != null)
      {
        ...
        if (localOnQueryTextListener.onQueryTextSubmit$552c4dfd()) {}
      }
      else
      {
  ...
  private void updateSearchAutoComplete()
  {
    ...
    if (this.mSearchable.getSuggestAuthority() != null)
    {
      ...
      localSuggestionsAdapter.mQueryRefinement = i;
    }
  }
