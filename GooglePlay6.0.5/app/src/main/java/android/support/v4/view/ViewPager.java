  ...
  extends ViewGroup
{
  ...
  private void onPageScrolled(int paramInt1, float paramFloat, int paramInt2)
  {
    if (this.mDecorChildCount > 0)
    {
      ...
      if (i6 < i5)
      {
        ...
        for (;;)
        {
          int i8 = i7 + i1 - localView2.getLeft();
          if (i8 != 0) {
            localView2.offsetLeftAndRight(i8);
          }
          i6++;
          break;
          i7 = i2;
          ...
          continue;
          i7 = Math.max((i4 - localView2.getMeasuredWidth()) / 2, i2);
          continue;
          i7 = i4 - i3 - localView2.getMeasuredWidth();
    ...
    if (this.mOnPageChangeListeners != null)
    {
      int m = this.mOnPageChangeListeners.size();
      for (int n = 0; n < m; n++)
      {
        OnPageChangeListener localOnPageChangeListener = (OnPageChangeListener)this.mOnPageChangeListeners.get(n);
        if (localOnPageChangeListener != null) {
    ...
    for (;;)
    {
      ...
      if (getWindowToken() != null)
      {
        ...
        if (i2 < i3)
        {
          ...
          int i22 = localItemInfo8.position;
          int i23 = this.mCurItem;
          localObject1 = null;
          if (i22 == i23) {
        ...
        if (localObject1 != null)
        {
          ...
          for (ItemInfo localItemInfo5 = (ItemInfo)this.mItems.get(i8);; localItemInfo5 = null)
          {
            i10--;
            break label393;
            label504:
            ...
            localItemInfo5 = null;
            break label371;
            f2 = 2.0F - ((ItemInfo)localObject1).widthFactor + getPaddingLeft() / i9;
            break label385;
          }
          if (localItemInfo5 != null)
          {
          ...
          int i19 = i8 + 1;
          f1 += addNewItem(i10, i19).widthFactor;
          i2++;
          if (i8 >= 0) {}
          for (localItemInfo5 = (ItemInfo)this.mItems.get(i8);; localItemInfo5 = null) {
            break;
          ...
          if (f3 < 2.0F)
          {
            ...
            if (i11 < i12)
            {
              localItemInfo6 = (ItemInfo)this.mItems.get(i11);
              if (i9 > 0) {
                break label847;
              }
              f4 = 0.0F;
              ...
              if ((i13 == i17) && (!localItemInfo6.scrolling))
              {
                this.mItems.remove(i11);
                PagerAdapter localPagerAdapter2 = this.mAdapter;
                Object localObject3 = localItemInfo6.object;
                localPagerAdapter2.destroyItem(this, i13, localObject3);
                int i18 = this.mItems.size();
                if (i11 >= i18) {
                  break label863;
                }
              }
            }
            for (ItemInfo localItemInfo6 = (ItemInfo)this.mItems.get(i11);; localItemInfo6 = null)
            {
              i13++;
              break label723;
              localItemInfo6 = null;
              break;
              f4 = 2.0F + getPaddingRight() / i9;
              break label715;
            }
            if (localItemInfo6 != null)
            {
              int i15 = localItemInfo6.position;
              if (i13 == i15)
              {
                f3 += localItemInfo6.widthFactor;
                i11++;
                int i16 = this.mItems.size();
                if (i11 < i16) {}
                for (localItemInfo6 = (ItemInfo)this.mItems.get(i11);; localItemInfo6 = null) {
                  break;
                }
              }
            }
            ItemInfo localItemInfo7 = addNewItem(i13, i11);
            i11++;
            f3 += localItemInfo7.widthFactor;
            int i14 = this.mItems.size();
            if (i11 < i14) {}
            for (localItemInfo6 = (ItemInfo)this.mItems.get(i11);; localItemInfo6 = null) {
              break;
            }
        ...
        {
          localPagerAdapter1.setPrimaryItem$30510aeb(i4, localObject2);
          this.mAdapter.finishUpdate$52bc874c();
          int i5 = getChildCount();
  ...
  private void setScrollState(int paramInt)
  {
    ...
    do
    {
      ...
      if (this.mPageTransformer != null)
      {
        ...
        for (int i1 = 2;; i1 = 0)
        {
          ViewCompat.setLayerType(getChildAt(n), i1, null);
          n++;
          break label39;
          k = 0;
          break;
    ...
    } while (this.mInternalPageChangeListener == null);
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!KeyEventCompat.hasModifiers$79c6ddc0(paramKeyEvent)) {
          break;
        }
        bool2 = arrowScroll(1);
      }
  ...
  public final ItemInfo infoForChild(View paramView)
  {
    for (int i = 0; i < this.mItems.size(); i++)
    {
      ItemInfo localItemInfo = (ItemInfo)this.mItems.get(i);
    ...
    for (;;)
    {
      ...
      if (j != -1)
      {
        ...
        if (f4 != 0.0F)
        {
          ...
          for (int m = 1; (m == 0) && (canScroll(this, false, (int)f4, (int)f3, (int)f6)); m = 0)
          {
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    if (this.mAdapter != null) {
      localSavedState.adapterState = null;
    }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    case 1: 
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          i3 = MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId);
          if (i3 != -1) {
            break;
          }
          bool1 = resetTouch();
        ...
        for (float f7 = this.mInitialMotionX + this.mTouchSlop;; f7 = this.mInitialMotionX - this.mTouchSlop)
        {
    ...
    label764:
    for (int i2 = Math.max(localItemInfo2.position, Math.min(i1, localItemInfo3.position));; i2 = i1)
    {
  ...
  public final void setPageTransformer$382b7817(PageTransformer paramPageTransformer)
  {
    if (Build.VERSION.SDK_INT >= 11) {
      if (this.mPageTransformer == null) {
        break label50;
