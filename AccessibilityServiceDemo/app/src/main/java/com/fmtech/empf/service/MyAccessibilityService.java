...
import com.android.talkback.contextmenu.TalkBackRadialMenuClient;
...
public class MyAccessibilityService extends AccessibilityService
    ...
    private final static String LOGTAG = "MyAccessiblityService";
...
//        mAnalytics.onGesture(gestureId);
    ...
    protected void onServiceConnected() {
        ...
        if (!TalkBackPreferencesActivity.isTouchExplorationEnabled(resolver) || !showTutorial()) {
    ...
    public static int getServiceState() {
        final MyAccessibilityService service = getInstance();
        if (service == null) {
    ...
    private void initializeInfrastructure() {
        ...
        if (Build.VERSION.SDK_INT >= KeyComboManager.MIN_API_LEVEL) {
            ...
            // Search mode should receive key combos immediately after the MyAccessiblityService.
...
//        mAnalytics = new TalkBackAnalytics(this);
                ...
                public boolean onComboPerformed(int id) {
                    switch (id) {
                        ...
                        case KeyComboManager.ACTION_HOME:
                            MyAccessibilityService.this.performGlobalAction(GLOBAL_ACTION_HOME);
                            return true;
                        case KeyComboManager.ACTION_NOTIFICATION:
                            MyAccessibilityService.this.performGlobalAction(GLOBAL_ACTION_NOTIFICATIONS);
                            return true;
     ...
     * <p>
     * {@link MyAccessibilityService#addServiceStateListener(ServiceStateListener)}
     * {@link MyAccessibilityService#removeServiceStateListener(ServiceStateListener)}
     * {@link MyAccessibilityService#SERVICE_STATE_INACTIVE}
     * {@link MyAccessibilityService#SERVICE_STATE_ACTIVE}
     * {@link MyAccessibilityService#SERVICE_STATE_SUSPENDED}
     */
...
// * @create_date 2015/12/10 10:48
// * @description ${todo}
// * <p/>
// * Modification History:
// * Date            Author            Version         Description
// * -----------------------------------------------------------------
// * 2015/12/10 10:48  Drew.Chiang       v1.0.0          create
// * <p/>
// * ==================================================================
// */
//
...
//    @Override
//    public void onAccessibilityEvent(AccessibilityEvent event) {
////        System.out.println("-------onAccessibilityEvent--event.getText():"+event.getText());
...
//        System.out.println("-------speakToUser: " + msg);
//        TextToSpeechController TTSController = TextToSpeechController.getInstance(MyAccessibilityService.this);
////        msg = "测试";
//        TTSController.speak(msg);
//    }
//
//    @Override
//    public void onInterrupt() {
...
//                { "com.fmtech.accessibilityservicedemo"};
//
