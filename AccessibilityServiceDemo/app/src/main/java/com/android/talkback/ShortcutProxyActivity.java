...
public class ShortcutProxyActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent.setAction(MyAccessibilityService.ACTION_PERFORM_GESTURE_ACTION);
        intent.putExtra(MyAccessibilityService.EXTRA_GESTURE_ACTION,
                R.string.shortcut_value_talkback_breakout);

        sendBroadcast(intent, MyAccessibilityService.PERMISSION_TALKBACK);
        finish();
    }
}
