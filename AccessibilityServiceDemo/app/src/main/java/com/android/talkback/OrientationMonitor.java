...
public class OrientationMonitor {
    ...
    public OrientationMonitor(SpeechController speechController, MyAccessibilityService context) {
    ...
    /**
     * Called by {@link MyAccessibilityService} when the configuration changes.
     *
