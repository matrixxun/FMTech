...
class RuleUnlabeledImage implements NodeMenuRule {
    ...
    @Override
    public List<ContextMenuItem> getMenuItemsForNode(MyAccessibilityService service,
    ...
    private static class UnlabeledImageMenuItemClickListener
        ...
        public UnlabeledImageMenuItemClickListener(
                MyAccessibilityService service, AccessibilityNodeInfoCompat node, Label label) {
            mContext = service;
            mNode = node;
