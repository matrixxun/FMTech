...
public class EventSpeechRule {
     ...
     */
    private EventSpeechRule(MyAccessibilityService context, Node node, int ruleIndex) {
        mContext = context;
        mNode = node;
     ...
     */
    public static ArrayList<EventSpeechRule> createSpeechRules(MyAccessibilityService context,
    ...
    private class DefaultFilter implements AccessibilityEventFilter {
        ...
        @Override
        public boolean accept(AccessibilityEvent event, MyAccessibilityService context) {
    ...
    private class DefaultFormatter implements AccessibilityEventFormatter {
        ...
        @Override
        public boolean format(AccessibilityEvent event, MyAccessibilityService context,
                Utterance utterance) {
    ...
    public interface AccessibilityEventFilter {
         ...
         */
        boolean accept(AccessibilityEvent event, MyAccessibilityService context);
    }
    ...
    public interface ContextBasedRule {
         ...
         */
        public void initialize(MyAccessibilityService context);
    }
}
