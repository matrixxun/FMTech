...
public final class TextFormatters {
    ...
    public static final class ChangedTextFormatter
        ...
        private void notifyMaxLengthReached(AccessibilityEvent event,
                                            MyAccessibilityService context, Utterance utterance) {
        ...
        private int formatInternal(AccessibilityEvent event, MyAccessibilityService context,
                                   Utterance utterance) {
    ...
    public static final class SelectedTextFormatter
        ...
        private boolean formatInternal(AccessibilityEvent event, MyAccessibilityService context,
                                       Utterance utterance) {
    ...
    private static boolean shouldSpeakPasswords(MyAccessibilityService service) {
        if (service == null) {
            return false;
        }
